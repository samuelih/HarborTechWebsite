  ...
  return (
    <div className="pt-16">
        ...
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div className="card service-card relative overflow-hidden border-t-4 border-t-nautical-azure">
              <div className="absolute top-0 right-0 w-16 h-16 text-nautical-azure/10">
              ...
              <h3 className="font-display text-2xl mb-4 font-bold">Smart POS Systems</h3>
            ...
            <div className="card service-card relative overflow-hidden border-t-4 border-t-nautical-deepBlue">
              <div className="absolute top-0 right-0 w-16 h-16 text-nautical-deepBlue/10">
                <svg viewBox="0 0 800 800" fill="currentColor" className="w-full h-full">
              ...
              <h3 className="font-display text-2xl mb-4 font-bold">Cloud Solutions</h3>
              <p className="text-neutral-700 mb-6">
            ...
            <div className="card service-card relative overflow-hidden border-t-4 border-t-nautical-seafoam">
              <div className="absolute top-0 right-0 w-16 h-16 text-nautical-seafoam/10">
                <svg viewBox="0 0 800 800" fill="currentColor" className="w-full h-full">
              ...
              <h3 className="font-display text-2xl mb-4 font-bold">Data Analytics</h3>
              <p className="text-neutral-700 mb-6">
      ...
      <section className="py-16 bg-nautical-sand">
        <div className="container mx-auto px-4">
          <h2 className="section-heading text-center mb-16">Our Service Voyage</h2>
      ...
      <section className="py-16 bg-nautical-gradient text-white">
        <div className="container mx-auto px-4 text-center">
          <h2 className="font-display font-bold text-3xl mb-6">Ready to Set Sail?</h2>
