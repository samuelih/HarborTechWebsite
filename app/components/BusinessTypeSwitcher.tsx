          ...
          >
            ...
            <div className="mt-4 text-right">
              <span className={`text-sm font-medium ${
                activeType === key ? `text-${business.accentColor}` : 'text-neutral-400'
              }`}>
          ...
          >
            <div className="bg-white rounded-2xl p-8 border-2 border-neutral-100 shadow-lg">
              <div className="text-center mb-8">
                <div className={`inline-flex items-center justify-center w-16 h-16 bg-${businessTypes[activeType].accentColor} rounded-xl mb-4`}>
                  <Image
                  ...
                  <ul className="space-y-3">
                    {businessTypes[activeType].highlights.map((highlight, index) => (
                      <li key={index} className="flex items-start">
                        <div className={`w-2 h-2 bg-${businessTypes[activeType].accentColor} rounded-full mt-2 mr-3 flex-shrink-0`}></div>
