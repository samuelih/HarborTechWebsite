...
const PricingSection = () => {
  ...
  return (
    <section 
      ...
      id="packages"
      style={{
        background: 'linear-gradient(to bottom, #F7F1E3 0%, #FFF8EC 100%)'
      }}
    >
      ...
      <div className="absolute inset-0 overflow-hidden">
        ...
        {/* Decorative elements */}
        <div className="absolute top-1/4 left-10 w-40 h-40 rounded-full bg-accent-seafoam/5 blur-3xl"></div>
        <div className="absolute bottom-1/4 right-10 w-60 h-60 rounded-full bg-accent-gold/5 blur-3xl"></div>
      ...
      <Container className="relative z-10">
        ...
        >
          <SectionHeading 
            ...
            className="mb-4"
          />
          <p className="text-center max-w-2xl mx-auto mb-6 text-secondary-navy/80">
            Transparent, fixed-cost technology packages to fit any retail operation size.
          </p>
          
          {/* Trust badges above pricing cards */}
          <div className="flex flex-wrap justify-center gap-4 mb-12">
            <div className="flex items-center bg-white/50 backdrop-blur-sm px-4 py-1.5 rounded-full border border-accent-sand/50">
              <svg className="w-4 h-4 text-primary-700 mr-2" viewBox="0 0 24 24" fill="currentColor">
                <path d="M12,1L3,5V11C3,16.55 6.84,21.74 12,23C17.16,21.74 21,16.55 21,11V5L12,1Z" />
              </svg>
              <span className="text-sm text-secondary-navy">Money-back guarantee</span>
            </div>
            <div className="flex items-center bg-white/50 backdrop-blur-sm px-4 py-1.5 rounded-full border border-accent-sand/50">
              <svg className="w-4 h-4 text-primary-700 mr-2" viewBox="0 0 24 24" fill="currentColor">
              ...
              <span className="text-sm text-secondary-navy">Local Harbor Springs experts</span>
            </div>
            <div className="flex items-center bg-white/50 backdrop-blur-sm px-4 py-1.5 rounded-full border border-accent-sand/50">
              <svg className="w-4 h-4 text-primary-700 mr-2" viewBox="0 0 24 24" fill="currentColor">
                <path d="M13,9H11V7H13V9M13,17H11V11H13V17M12,2A10,10 0 0,0 2,12A10,10 0 0,0 12,22A10,10 0 0,0 22,12A10,10 0 0,0 12,2Z" />
              </svg>
              <span className="text-sm text-secondary-navy">Transparent pricing</span>
            </div>
          </div>
        </div>
        ...
        <div 
          className="text-center mt-8 bg-white/50 backdrop-blur-sm mx-auto max-w-lg rounded-xl p-4 border border-accent-sand/30"
          style={{
            opacity: isVisible ? 1 : 0,
            transform: isVisible ? 'translateY(0)' : 'translateY(20px)',
        ...
        >
          <div className="flex items-center justify-center mb-2">
            <svg className="w-5 h-5 text-primary-700 mr-2" viewBox="0 0 24 24" fill="currentColor">
          ...
          <p className="text-secondary-navy/80 mb-3 text-sm">
            We'll work with you to build a custom package tailored to your specific retail needs.
          </p>
          <Link 
            href="/contact" 
            className="text-primary-700 hover:text-primary-500 font-semibold inline-flex items-center group transition-colors duration-300"
          >
