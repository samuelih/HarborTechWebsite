...
const WhyChooseUsSection = () => {
  ...
  return (
    ...
    >
      ...
      {/* Section Transition - Wave to Services section */}
      <div className="absolute bottom-0 left-0 w-full h-12 overflow-hidden">
        ...
        >
          <path 
            fill="#0E2A47" 
            fillOpacity="0.7"
            d="M0,0 C120,20 240,30 360,30 C480,30 600,20 720,15 C840,10 960,10 1080,15 C1200,20 1320,30 1440,40 L1440,48 L0,48 Z"
          />
        </svg>
      </div>
