  ...
  return (
    <>
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="text-center">
            ...
            <p className="text-white/90 text-lg md:text-xl mb-10 max-w-2xl mx-auto">
              Local experts ready to help you navigate any technical challenges. Quick, friendly, and reliable support.
            </p>
          </div>
        </div>
      ...
      <section className="py-16 bg-white relative overflow-hidden">
        ...
        <div className="absolute top-20 right-5 w-32 h-32 opacity-10">
          <Image 
        ...
        <div className="absolute bottom-20 left-5 w-24 h-24 opacity-10">
          <Image 
